//
//  CECollectionViewController.m
//  TableViewRefresh
//
//  Created by CE on 2017/6/28.
...
@interface CECollectionViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,JMWaterflowLayoutDelegate,CETimeCountDownDelegate>{
...
- (void)viewDidLoad {
    ...
    _countDown = [[CETimeCountDown alloc] initWithScrollView:self.collectionView dataList:self.dataList];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CECollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([CECollectionViewCell class]) forIndexPath:indexPath];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([CECollectionViewCell class]) bundle:nil] forCellWithReuseIdentifier:NSStringFromClass([CECollectionViewCell class])];
...
//    }
    ...
    for (int i = 0; i < 100; i ++) {
        ...
        model.startTime = [CETimeCountDownDateTool dateByAddingSeconds:arc4random()%10000+60 timeStyle:_countDown.timeStyle];
