...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
        {
            ...
            CERegularlyViewController *VC = [[CERegularlyViewController alloc] initWithNibName:NSStringFromClass([CERegularlyViewController class]) bundle:nil];
            VC.title = title;
        ...
        case 3:
        {
            CECollectionViewController *VC = [CECollectionViewController new];
            VC.title = title;
              [self.navigationController pushViewController:VC animated:YES];
        }
            break;
        case 4:
        {
            CEVerificationController *VC = [CEVerificationController new];
            VC.title = title;
            [self.navigationController pushViewController:VC animated:YES];
        }
            break;
