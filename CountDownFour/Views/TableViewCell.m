...
//    self.timeLabel.timeKey = @"startTime";
    ...
    //边框模式
    self.timeLabel.textStyle = CETextStlyeDDHHMMSSChineseBox;
...
- (void)setupTwoLabelP{
    ...
    self.twoTimeLabel.textStyle = CETextStlyeDDHHMMSSBox;
    self.twoTimeLabel.jj_description = @"活动结束了！😄😄";
    //边框模式
    self.twoTimeLabel.textStyle = CETextStlyeDDHHMMSSChineseBox;
...
- (void)setupThreeLabelP{
    ...
    //边框模式
    self.threeTImeLabel.textStyle = CETextStlyeDDHHMMSSChineseBox;
    //字体颜色
