...
@protocol CETimeCountDownCellManagerDelegate <NSObject>
...
@interface CETimeCountDownCellManager : NSObject

@property (nonatomic ,weak) id <CETimeCountDownCellManagerDelegate> delegate;
