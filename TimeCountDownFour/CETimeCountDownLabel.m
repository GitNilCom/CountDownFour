...
#import "UIImage+CETimeCountDown.h"
#import "CETimeCountDownLabelTextStlyeTool.h"

static NSString *const kCETimeCountDownLabelDescription = @"活动已经结束！";

@interface CETimeCountDownLabel (){
...
@implementation CETimeCountDownLabel
...
- (void)setupDefultProperty{
    ...
    _jj_description = kCETimeCountDownLabelDescription;
    _textIntervalSymbol = @":";
...
- (void)drawRect:(CGRect)rect{
    ...
    if ([self.attributedText.string isEqualToString:self.jj_description]) {
        ...
        if (self.isRetainFinalValue) {
            ...
            if ([CETimeCountDownLabelTextStlyeTool isBoxStyleWithLabel:self]) {
...
- (NSAttributedString *)addTextEffectWithAttributedString:(NSAttributedString *)att{
    ...
    if (self.effectStlye == CETextEffectStlyeHollow) {
...
- (void)drawBoxWithRext:(CGRect)rect{
    ...
    NSArray *textArray = [CETimeCountDownLabelTextStlyeTool getTextArrayWithLabel:self];
    //保存单个文本宽度
    ...
    CGRect newRect = [CETimeCountDownLabelTextStlyeTool textBoxAlignmentRectWithLabel:self boxWidth:labelWidth rect:rect];
...
- (void)setJj_description:(NSString *)jj_description{
    ...
    if ([self isNillWithString:jj_description]) {
        self.jj_description = kCETimeCountDownLabelDescription;
    }
}

- (void)setTextStyle:(CETextStlye)textStyle{
...
- (void)setTextAlignment:(NSTextAlignment)textAlignment{
    ...
    self.jj_textAlignment = CETextAlignmentStlyeLeftCenter;
    [self setNeedsDisplay];
    switch (textAlignment) {
        case NSTextAlignmentCenter:
        {
            self.jj_textAlignment = CETextAlignmentStlyeCenter;
        }
            break;
        case NSTextAlignmentRight:
        {
            self.jj_textAlignment = CETextAlignmentStlyeCenterRight;
        }
            break;
        default:
            break;
