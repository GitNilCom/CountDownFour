...
@interface CETimeCountDownModel:NSObject
@property (nonatomic ,strong) CETimeCountDownLabel *timeLabel;
@property (nonatomic ,strong) NSString *time;
@end

@implementation CETimeCountDownModel
@end

@interface CETimeCountDownLabelManager ()

@property (nonatomic ,strong) NSMutableArray *timeLabelDataList;

@end

@implementation CETimeCountDownLabelManager{
...
- (void)addTimeLabel:(CETimeCountDownLabel *)timeLabel time:(NSString *)time{
    ...
    if (timeLabel&&time) {
        ...
        CETimeCountDownModel *model = [[CETimeCountDownModel alloc] init];
...
- (void)setupTimeLabelText{
    ...
    for (CETimeCountDownModel *model in self.timeLabelDataList) {
